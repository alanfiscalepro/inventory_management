              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-[var(--border-color)]">
                    <button className="flex-1 px-6 py-4 bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--text-primary)] rounded-lg hover:border-[var(--accent-cyan)] hover:bg-[var(--bg-hover)] transition-all text-base font-semibold">
                      View Details
                    </button>
                    <button className="flex-1 px-6 py-4 bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--text-primary)] rounded-lg hover:border-[var(--accent-amber)] hover:bg-[var(--bg-hover)] transition-all text-base font-semibold">
                      Edit
                    </button>
                  </div>
                </motion.div>
